...
PACKAGE ?= helm-dragonfly
XRD_DIR := apis/dragonflies
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/dragonflies/standard.yaml
...
EXAMPLES := \
    examples/dragonflies/minimal.yaml:: \
    examples/dragonflies/standard.yaml::
...
render\:%:
	@example="examples/dragonflies/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
